                        ...
                        <div class="card bg-white border rounded-4 mb-4">
                            <div class="card-body p-3">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="telegram_link" class="form-control" id="telegramLink" placeholder="Telegram URL">
                                    </div>
                                    <div class="col-md-4">
                                        <input type="text" name="business_link" class="form-control" id="businessLink" placeholder="Business Website">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<style>
    ...
    .mobile-preview .btn, .desktop-preview .btn {
