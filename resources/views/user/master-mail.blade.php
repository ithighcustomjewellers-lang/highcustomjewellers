...
<style>
    ...
    #emailEditor {
        ...
        position: relative;   /* ✅ FIX: placeholder को सही जगह दिखाने के लिए */
    }
    #emailEditor:focus {
                ...
                <div class="card-body p-4">
                    <form id="emailForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="d-flex gap-3 mt-4">
                            ...
                            <a href="{{ route('master-data-list') }}" class="btn btn-outline-secondary btn-lg px-4 rounded-pill">← Back</a>
                        </div>
                    </form>
                </div>
            </div>
