    ...
    <div class="row g-4">
        ...
        <div class="col-lg-2 col-md-6">
            <div class="card dashboard-card shadow-sm border-0">
                <a href="{{ route('report.campaign') }}" class="text-decoration-none text-dark d-block">
        ...
        <!-- Sent -->
        <div class="col-lg-2 col-md-6">
            <a href="{{ route('report.campaign', ['status' => 'send']) }}" class="text-decoration-none text-dark d-block">
        ...
        <!-- Seen -->
        <div class="col-lg-2 col-md-6">
            <a href="{{ route('report.campaign', ['status' => 'seen']) }}" class="text-decoration-none text-dark d-block">
                <div class="card dashboard-card shadow-sm border-0 h-100">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
        ...
        <!-- Fail -->
        <div class="col-lg-2 col-md-6">
            <a href="{{ route('report.campaign', ['status' => 'failed']) }}" class="text-decoration-none text-dark d-block">
                <div class="card dashboard-card shadow-sm border-0 h-100">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <div>
        ...
        <!-- Interested -->
        <div class="col-lg-2 col-md-6">
            <a href="{{ route('report.campaign', ['status' => 'interested']) }}"
