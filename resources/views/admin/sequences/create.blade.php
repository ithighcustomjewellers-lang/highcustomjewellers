            ...
            <div class="card p-4">
                ...
                <form id="emailForm" action="{{ route('admin-sequences-store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="toolbar mb-2">
                        <button type="button" onclick="formatText('bold')" class="btn btn-sm btn-outline-secondary"><b>B</b></button>
                        <button type="button" onclick="formatText('italic')" class="btn btn-sm btn-outline-secondary"><i>I</i></button>
                        <button type="button" onclick="formatText('underline')" class="btn btn-sm btn-outline-secondary"><u>U</u></button>

                        <select id="fontFamilySelect" onchange="formatText('fontName', this.value)" class="form-control-sm">
                        ...
                        <button type="button" onclick="formatText('justifyLeft')" class="btn btn-sm btn-outline-secondary">⍇</button>
                        <button type="button" onclick="formatText('justifyCenter')" class="btn btn-sm btn-outline-secondary">⍌</button>
                        <button type="button" onclick="formatText('justifyRight')" class="btn btn-sm btn-outline-secondary">⍄</button>
                        <button type="button" onclick="addHorizontalLine()" class="btn btn-sm btn-outline-secondary">─</button>
                    </div>

                    <!-- Email Content Editor -->
                    <div id="emailEditor" class="form-control mb-2" contenteditable="true" style="min-height: 300px; border: 1px solid #ddd; padding: 10px; overflow-y: auto; font-size: 16px; font-family: Arial;">
                    ...
                    <!-- Hero Image Upload - Separate section -->
                    <div class="mb-3">
                    ...
                    <!-- Attachments Image Upload - Separate section -->
                    <div class="mb-3">
                        ...
                        <div id="attachmentPreview" class="mt-2" style="display:none;">
                            <div class="alert alert-info">
                                ...
                                <button type="button" class="btn btn-sm btn-danger float-end" onclick="removeAttachment()">Remove</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-2 p-2">
                        ...
                        <input type="text" name="whatsapp_link" class="form-control mb-2" id="whatsappLink" placeholder="WhatsApp Link (https://wa.me/...)">
                        <input type="text" name="telegram_link" class="form-control mb-2" id="telegramLink" placeholder="Telegram Link (https://t.me/...)">
        ...
        <div class="col-md-6">
            <div class="card p-4">
                ...
                <div class="preview-container">
                    ...
                    <!-- Email Preview Area -->
                    <div id="emailPreview" class="email-preview" style="border: 1px solid #e0e0e0; padding: 20px; min-height: 400px; background: #fff; display: none;">
...
<script>
    ...
    function previewAttachment(input) {
        if (input.files && input.files[0]) {
            ...
            document.getElementById('attachmentName').innerHTML = `${currentAttachment.name} (${currentAttachment.size})`;
    ...
    // Update live preview with all elements
    function updatePreview() {
        ...
        if (whatsapp || telegram || business) {
            buttonsHtml = '<div style="margin-top: 20px; padding: 15px; text-align: center; background: #f8f9fa; border-radius: 8px;">';

            if (whatsapp) {
                buttonsHtml += `<a href="${whatsapp}" class="btn btn-success" style="background-color:#25D366; color:white; padding:10px 20px; margin:5px; text-decoration:none; border-radius:5px; display:inline-block;" target="_blank">📱 WhatsApp</a>`;
            }

            if (telegram) {
                buttonsHtml += `<a href="${telegram}" class="btn btn-info" style="background-color:#0088cc; color:white; padding:10px 20px; margin:5px; text-decoration:none; border-radius:5px; display:inline-block;" target="_blank">📨 Telegram</a>`;
            }

            if (business) {
                buttonsHtml += `<a href="${business}" class="btn btn-primary" style="background-color:#007bff; color:white; padding:10px 20px; margin:5px; text-decoration:none; border-radius:5px; display:inline-block;" target="_blank">💼 Business</a>`;
            }
        ...
        // Save to hidden textarea for form submission
