...
<div class="container-fluid py-4">
    ...
    <div class="sequence-header">
        ...
        <a href="{{ route('admin-Master-index') }}" class="btn add-sequence-btn">
    ...
    <div class="sequence-card">
        ...
        <div class="table-responsive">
            <table id="adminsequencesTable" class="table align-middle sequence-table">
...
$(document).ready(function() {
    ...
    var table = $('#adminsequencesTable').DataTable({
        processing:true,
        serverSide:true,
        responsive:true,
        ajax:{
            url:"{{ route('admin-getSequences-data') }}",
            type:'POST',
            headers:{
    ...
    $('#adminsequencesTable tbody').on('click', 'td.editable-cell', function() {
    ...
    //     $.ajax({
    //         url:"{{ route('admin-master-list-sequences-inlineUpdate') }}",
    //         type:"POST",
    //         data:{
    //             _token:'{{ csrf_token() }}',
    //             id:id,
    ...
    table.on('draw',function(){
        $('#adminsequencesTable tbody tr').each(function(){
...
function deleteList(id)
{
    Swal.fire({
        ...
        {
            $.ajax({
                url: "{{ route('admin-sequence-delete') }}",
                type: "POST",
                data: {
                    id: id,
                    _token: "{{ csrf_token() }}"
